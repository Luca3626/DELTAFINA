...
namespace CommunicationLib
{
        public class CRC16_V2
        {
            ...
            /// <summary>
            /// Restituisce il crc in formato int
            /// </summary>
            /// <param name="modbusframe"></param>
            /// <param name="Length"></param>
            /// <returns></returns>
            public int Crc16_I(byte[] modbusframe, int Length)
            {
                int i;
                int index;
                int crc_Low = 0xFF;
            ...
            /// <summary>
            /// Restituisce il crc in formato byte[]
            /// </summary>
            /// <param name="modbusframe"></param>
            /// <param name="Length"></param>
            /// <returns></returns>
            public byte[] Crc16_B(byte[] modbusframe, int Length)
            {
                int i;
                int index;
                int crc_Low = 0xFF;

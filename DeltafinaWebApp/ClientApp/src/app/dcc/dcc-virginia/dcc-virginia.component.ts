...
@Component({
  selector: 'dcc-virginia', // tslint:disable-line
  templateUrl: './dcc-virginia.component.html',
  styleUrls: ['dcc-virginia.css'],
})
export class DccVirginiaComponent implements OnInit {
  ...
  // I motori di questa pagina (V11..V18A) stanno nella zona 1.0 - Virginia Infeed:
  ...
  // #region Finecorsa del cilindro VDCC (DB121 - TO_HMI)
  // Tre spie di stato in testata: rotazione del tamburo (V13_LS, X0285: impulsi a
  // tamburo in moto, la spia pulsa con il finecorsa), martinetto idraulico in basso
  // (V14_LS_Dwn, X0243) e tendicinghia del nastro lasco (V14a_LS, X0286). Il tag si
  ...
  get drumRotationPulse(): boolean { return this.lsOn('PLC_VDCC_V13_LS'); }
  get jackDown(): boolean { return this.lsOn('PLC_VDCC_V14_LS_Dwn'); }
  get tensionerLoose(): boolean { return this.lsOn('PLC_VDCC_V14a_LS'); }
  // #endregion

...
export class SiloPlateComponent {
  ...
  async loadInfo() {
    ...
    //if (this.data.silo.name == "V21" || this.data.silo.description == "S1" || this.data.silo.description == "S2")
    //  this.siloInfo = await this.siloService.getByName(this.data.silo.name);
    //else
    //  this.siloInfo = await this.siloService.getByCode(this.data.silo.name);
